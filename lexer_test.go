...
func TestLex(t *testing.T) {
	...
	expected := []TokenType{
		IDENT, POW_EQ, LPAREN, DECIMAL, POW, LPAREN, DECIMAL, ADD, DECIMAL, SUB,
		DECIMAL, RPAREN, RPAREN, LSH_EQ, DECIMAL, REM, UNARY_MIN, DECIMAL, EOL,
	}
...
func TestOperators(t *testing.T) {
	...
	expected := []TokenType{
		...
		AND, LSH, RSH, NOT, ADD, DECIMAL, SUB, MUL, DIV, POW, REM, UNARY_MIN, EOL,
	}
